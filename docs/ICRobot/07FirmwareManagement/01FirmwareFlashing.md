...
|![](img/S6.png)|![](img/S7.png)|
|Step 6: Choose the correct COM port for firmware burning.|Step 7: Select the firmware type to be flashed: Default Flashing — Standard firmware version. After selecting the desired version, click Upgrade.<br/>Note: If the selected firmware version name does not include the label “(Local Firmware)”, the computer must be connected to the internet during the flashing process.|
|![](img/S8.png)|![](img/S9.png)|
